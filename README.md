...
This project involves creating an API for managing college and intern data. It allows creating college documents with logo links and creating intern documents associated with a specific college. The API also provides functionality to retrieve college details and the list of interns associated with a particular college.
